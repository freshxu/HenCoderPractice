package com.hencoder.hencoderpracticedraw6.practice.practice03;
...
public class Practice03OfObjectLayout extends RelativeLayout {
    ...
    private class PointFEvaluator implements TypeEvaluator<PointF> {
        ...
        public PointF evaluate(float fraction, PointF startValue, PointF endValue) {
            ...
            startValue.x = startValue.x + (endValue.x - startValue.x) * fraction;
            startValue.y = startValue.y + (endValue.y - startValue.y) * fraction;
            return startValue;
        }
    }
}
